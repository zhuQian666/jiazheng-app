...
export default {
  ...
  mounted() {
    this.$nextTick(function(){
        let icon = localStorage.getItem('AVATAR');
        this.defaultBg = icon !='null' ? icon : require('../../../assets/images/0014.png');
        this.$refs.avatar.style.background = `url(${this.defaultBg})no-repeat center/contain`
    })
  },
  methods: {
    // 上传文件
    ...
    postImg () {
      // 这里写接口
      console.log(this.headerImage.data)
