    ...
    <div class="index-top">
      <div class="index-top-info">
        <div class="index-top-user">
          <img src="../../../assets/images/0014.png" alt class="index-top-user-icon">
        </div>
      </div>
      <div class="index-top-user-name">张三</div>
      <div class="index-top-user-phone">188 2222 2222</div>
    </div>
    <div class="info">
      <group>
        <cell is-link value="已审核" @click.native>
          <span slot="title">
            <img src="../../../assets/images/003.png" alt class="info-icon">
            <span class="info-tit">实名认证</span>
          </span>
        </cell>
        <cell is-link @click.native="goAaddress">
          <span slot="title">
            <img src="../../../assets/images/004.png" alt class="info-icon">
            <span class="info-tit">地址管理</span>
          </span>
        </cell>
        <cell is-link @click.native>
          <span slot="title">
