    ...
    <div class="index-top">
      <div class="index-top-info">
        <div class="index-top-user">
          <img :src="userInfo.Img" alt class="index-top-user-icon">
        </div>
      </div>
      <div class="index-top-user-name">{{userInfo.Name}}</div>
      <div class="index-top-user-phone">{{userInfo.Tel}}</div>
    </div>
    <div class="info">
      <group>
        <cell is-link value="{{'userInfo.sReal'?'未认证':'已认证'}}" @click.native="handelFn(1)">
          <span slot="title">
