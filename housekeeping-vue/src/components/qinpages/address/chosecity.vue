...
.container{width:100%;border-top: 1px solid #ddd;}
...
.city-list{width:100%;}
.city-list .city-letter{font-weight: bold; font-size:20px;display:inline-block;padding-top:15px;padding-bottom:5px;border-bottom:1px solid #e8ecf1;width:100%;}
.city-list p{color:#666;width:95%;height:50px;line-height:50px;border-bottom:1px solid #e8ecf1;cursor:pointer;}
